...
// const getMultipleMeta = require('../../modules/comments/get_multiple_meta');
//
// const DbManager = require('../../modules/db/db_manager');
//
// describe('getting multiple comments meta', () => {
//     let currentRequest;
//     let currentResponse;
//     let requestCreator;
//     let responseCreator;
...
//             .then(result => {
//                 return getMultipleMeta(requestCreator._id, [result.commentId])
//                     .catch(error => {
...
//         return getMultipleMeta(requestCreator._id, [])
//             .catch(error => {
//                 expect(error).to.not.exist;
//             })
//             .then(result => {
...
//         return getMultipleMeta(requestCreator._id, ["6b2326c4dfc37f32f0935695"])
//             .catch(error => {
//                 expect(error).to.not.exist;
//             })
//             .then(result => {
